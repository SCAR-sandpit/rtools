...
### GBIF
As a widely used R package, <a href = "https://ropensci.org/tutorials/rgbif_tutorial/">rgbif</a> helps users retrieve data from the GBIF.  [occ_download()]("https://www.rdocumentation.org/packages/rgbif/versions/0.9.9/topics/occ_download") and [occ_search()]("https://www.rdocumentation.org/packages/rgbif/versions/0.9.9/topics/occ_search") are two common functions for retrieving GBIF occurrence data. Users can customize searched by paramter specifications.  For instance, 
```
...
```
Alternatively, users can download data directly from GBIF.  For example, [Antarctic Plant Database]("https://www.gbif.org/dataset/82d9ff5c-f762-11e1-a439-00145eb45e9a") harbors more than 50,000 occurrences of over 40,000 plant specimens from Antarctica, the sub-Antarctic islands and surrounding continents. 
